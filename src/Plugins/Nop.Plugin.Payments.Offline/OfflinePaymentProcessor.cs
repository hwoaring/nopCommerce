...
namespace Nop.Plugin.Payments.Offline
{
    ...
    public class OfflinePaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public bool HidePaymentMethod(IList<ShoppingCartItem> cart)
        {
            ...
            if (_offlinePaymentSettings.ShippableProductRequired && !_shoppingCartService.ShoppingCartRequiresShipping(cart))
                return true;
        ...
        {
            //settings
            _settingService.DeleteSetting<OfflinePaymentSettings>();

            //locales
            _localizationService.DeleteLocaleResources("Plugins.Payment.Offline");
        ...
        /// </remarks>
        public string PaymentMethodDescription => _localizationService.GetResource("Plugins.Payment.Offline.PaymentMethodDescription");
