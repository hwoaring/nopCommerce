            ...
            ProductAttributeMapping productAttributeMapping, ProductAttributeValue productAttributeValue, bool excludeProperties = false)
        {
            ...
            if (productAttributeValue != null)
            {
                ...
                model ??= new ProductAttributeValueModel
                {
                    ...
                    ShortName = string.IsNullOrEmpty(productAttributeValue.ShortName) ? productAttributeValue.Name : productAttributeValue.ShortName,
                    ...
                    AgentPriceAdjustment = productAttributeValue.AgentPriceAdjustment,
                    DistributorPriceAdjustment = productAttributeValue.DistributorPriceAdjustment,
                    MemberPriceAdjustment = productAttributeValue.MemberPriceAdjustment,
                    OldPriceAdjustment = productAttributeValue.OldPriceAdjustment,
            ...
            Product product, ProductAttributeCombination productAttributeCombination, bool excludeProperties = false)
        {
            ...
            if (productAttributeCombination != null)
            {
                ...
                model ??= new ProductAttributeCombinationModel
                {
                    ...
                    OverriddenDistributorPrice = productAttributeCombination.OverriddenDistributorPrice,
                    OverriddenAgentPrice = productAttributeCombination.OverriddenAgentPrice,
                    OverriddenOldPrice = productAttributeCombination.OverriddenOldPrice,
                    OverriddenProductCost = productAttributeCombination.OverriddenProductCost,
