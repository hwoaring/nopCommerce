    ...
    public partial class SettingController : BaseAdminController
    {
        ...
        public virtual async Task<IActionResult> Catalog(CatalogSettingsModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _settingService.SaveSettingOverridablePerStoreAsync(catalogSettings, x => x.EnableRegionalProduct, model.EnableRegionalProduct_OverrideForStore, storeScope, false);
        ...
        public virtual async Task<IActionResult> Order(OrderSettingsModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _settingService.SaveSettingOverridablePerStoreAsync(orderSettings, x => x.OnePagePaymentEnabled, model.OnePagePaymentEnabled_OverrideForStore, storeScope, false);
                await _settingService.SaveSettingOverridablePerStoreAsync(orderSettings, x => x.OneClickPaymentEnabled, model.OneClickPaymentEnabled_OverrideForStore, storeScope, false);
