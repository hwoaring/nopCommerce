...
namespace Senparc.Weixin.CommonService.Controllers
{
    public partial class OAuth2Controller : Controller
    {
        ...
        /// <returns></returns>
        public async Task<IActionResult> IndexAsync(string code, string state, string returnUrl)
        {
            ...
            try
            {
                ...
                if (oAuthUserInfo != null && !string.IsNullOrWhiteSpace(oAuthUserInfo.nickname))
                {
                    ...
                    if (weixinUser != null && weixinUser.UpdatedOnUtc.AddMinutes(10) < DateTime.UtcNow)//更新，10分钟内不更新
                    {
                        ...
                        weixinUser.OpenId = oAuthUserInfo.openid;
                        ...
                        weixinUser.Language = oAuthUserInfo.language;
                        ...
                        weixinUser.SubscribeTime = WechatDateTimeHelper.GetDateTimeFromXml(oAuthUserInfo.subscribe_time);
                        ...
                        weixinUser.SubscribeSceneType = Enum.TryParse<SubscribeSceneType>(oAuthUserInfo.subscribe_scene, true, out var sceneResult) ? sceneResult : SubscribeSceneType.ADD_SCENE_OTHERS;
                        weixinUser.QrScene = oAuthUserInfo.qr_scene;
                        weixinUser.QrSceneStr = oAuthUserInfo.qr_scene_str;
                    ...
                    else //插入
                    {
                        weixinUser = new WeixinUser()
                        {
                            ...
                            Language = oAuthUserInfo.language,
                            ...
                            SubscribeTime = WechatDateTimeHelper.GetDateTimeFromXml(oAuthUserInfo.subscribe_time),
