...
{
    /// <summary>
    /// Represents an WxMessage
    /// </summary>
    public partial class WxMessage : BaseEntity, ISoftDeletedEntity
    {
        /// <summary>
        /// 站点ID
        /// </summary>
        ...
        /// </summary>
        public byte MessageResponseTypeId { get; set; }
        /// <summary>
        /// 回复方式：被动方式 passive，客服方式 custom
        /// </summary>
        public MessageResponseType MessageResponseType
        {
            get => (MessageResponseType)MessageResponseTypeId;
            set => MessageResponseTypeId = (byte)value;
        }
        /// <summary>
        /// 消息类型
        /// </summary>
