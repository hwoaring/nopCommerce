    ...
    public partial class NewsCategoryBuilder : NopEntityBuilder<NewsCategory>
    {
        ...
        public override void MapEntity(CreateTableExpressionBuilder table)
        {
            table
                ...
                .WithColumn(nameof(NewsCategory.MetaImageUrl)).AsAnsiString(1024).Nullable()
                .WithColumn(nameof(NewsCategory.MetaLinkUrl)).AsAnsiString(1024).Nullable()
                .WithColumn(nameof(NewsCategory.ShareImageUrl)).AsAnsiString(1024).Nullable()
